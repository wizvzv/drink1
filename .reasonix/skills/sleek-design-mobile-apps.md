...
description: Design mobile apps, create screens, and manage Sleek projects with AI via the Sleek API
---
---
name: sleek-design-mobile-apps
...
- **New screens**: one screenshot per component + one combined screenshot of all components in the project.
- **Updated screens**: one screenshot per affected component.
